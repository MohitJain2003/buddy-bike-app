          ...
          {stats.map((stat, i) => (
            <ScrollReveal key={i} animation="slide-up" delay={i * 150} threshold={0.15}>
              <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)', width: '220px' }}>
                  <div style={{ 
                    color: 'var(--primary)', 
                    display: 'flex', 
                    alignItems: 'center', 
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 'var(--text-sm)', color: 'var(--text-muted)', whiteSpace: 'nowrap' }}>{stat.label}</div>
                  </div>
                </div>
              </div>
            </ScrollReveal>
